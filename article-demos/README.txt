...
The file code.html in this .zip was generated with all computations fully executed — that is, no sections were commented out, and no preprocessed data was used.
