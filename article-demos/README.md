...
\- simulated\_data.rds         : Simulated dataset used in examples, preprocessed for eficiency.
...
This will generate a .Rmd, .md and .html file.
...
The file code.html was generated with all computations fully executed — that is, no sections were commented out

and no preprocessed data was used.
