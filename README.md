...
probs(X,S=S4) #estimates the MLE transition probabilities given S2.
#>    past_{ -10,-5,-1 } a p(a|past)
#> 1                 000 0 0.4062500
#> 2                 000 1 0.5937500
#> 3                 001 0 0.3611111
#> 4                 001 1 0.6388889
...
MTDest(X,S=c(1,5,10),M=NULL,nIter=15,init=init, oscillations = TRUE)
#> $lambdas
#>      lam-0      lam-1      lam-5     lam-10 
#> 0.04877557 0.29561536 0.30757764 0.34803143 
#> 
#> $pj
#> $pj$`p_-1`
#>           0         1
#> 0 0.2940652 0.7059348
#> 1 0.4459345 0.5540655
#> 
#> $pj$`p_-5`
#>           0         1
#> 0 0.6013605 0.3986395
#> 1 0.2597908 0.7402092
#> 
#> $pj$`p_-10`
#>           0         1
#> 0 0.2612075 0.7387925
#> 1 0.4705979 0.5294021
#> 
#> 
#> $p0
#>    p_0(0)    p_0(1) 
...
#> $oscillations
#>         -1         -5        -10 
#> 0.04475861 0.10479508 0.07271438
