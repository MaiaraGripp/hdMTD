...
#'
#' A tibble with the sample sequences frequencies (including time 0), and the estimated
...
#' @param countsTab A tibble or a data frame with all sequences of size d+1 that appear in the sample,
...
#'  it's format and column names are important within [freqTab()] function.
#' @param complete Logical. If \code{TRUE} and if there are sequences that didn't appear in the sample,
#'the tibble will be completed with such sequences appearing 0 times.
#'
